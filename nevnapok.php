...
function nevnapos($ev,$ho,$nap)
{
  ...
  $nevnapok = [] ;
    ...
    $nevnapok[1] = array("", "Fruzsina","Ábel","Genovéva és Benjámin","Titusz és Leona",  
  ...
  if ($ev%4 != 0)
    $nevnapok[2] = array("", "Ignác","Karolina és Aida","Balázs","Ráhel és Csenge","Ágota és Ingrid",  
    ...
    $nevnapok[3] = array("", "Albin","Lujza","Kornélia","Kázmér","Adorján és Adrián","Leonóra és Inez",  
    ...
    $nevnapok[4] = array("", "Hugó","Áron","Buda, Richárd","Izidor","Vince","Vilmos és Bíborka",  
    ...
    $nevnapok[5] = array("", "Fülöp és Jakab","Zsigmond","Tímea és Irma","Mónika és Flórián",  
    ...
    $nevnapok[6] = array("", "Tünde","Kármen, Anita","Klotild","Bulcsú","Fatime","Norbert és Cintia",  
    ...
    $nevnapok[7] = array("", "Tihamér, Annamária","Ottó","Kornél és Soma","Ulrik","Emese és Sarolta",  
    ...
    $nevnapok[8] = array("", "Boglárka","Lehel","Hermina","Domonkos és Dominika","Krisztina",  
    ...
    $nevnapok[9] = array("", "Egyed és Egon","Rebeka és Dorina","Hilda","Rozália","Viktor és Lőrinc",  
    ...
    $nevnapok[10]= array("", "Malvin","Petra","Helga","Ferenc","Aurél","Brúnó és Renáta","Amália",  
    ...
    $nevnapok[11]= array("", "Marianna","Achilles","Győző","Károly","Imre","Lénárd","Rezső",  
    ...
    $nevnapok[12]= array("", "Elza","Melinda és Vivien","Ferenc és Olívia","Borbála és Barbara","Vilma",  
